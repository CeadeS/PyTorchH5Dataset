...
class TestH5Dataset(TestCase):
    def test_load_sample(self):
        ...
        image, shape = H5Dataset.load_sample(sample)
    ...
    def test_convert_samples_to_dataset(self):
        ...
        H5Dataset.convert_samples_to_dataset(dataframe, './test/data/tmp/dataset/h5/test_dataset_image.h5',
                                             data_mode='image',sub_batch_size=1)

        sh.copy('./test/data/test_dataset.csv','./test/data/tmp/dataset/h5/test_dataset_image.csv')
        dataset = H5Dataset('test_dataset_image','./test/data/tmp/dataset/h5/')
        im, (cl, idx) = dataset[0]
        ...
        H5Dataset.convert_samples_to_dataset(dataframe, './test/data/tmp/dataset/h5/test_dataset_image.h5',
                                             data_mode='image',sub_batch_size=2)
    ...
    def test_num_samples(self):
        ...
        os.makedirs('./test/data/tmp/dataset/h5/',exist_ok=True)
        sh.copy('./test/data/test_dataset.csv','./test/data/tmp/dataset/h5/test_dataset.csv')
        H5Dataset.convert_samples_to_dataset(dataframe, './test/data/tmp/dataset/h5/test_dataset.h5', sub_batch_size=1)
        dataset = H5Dataset('test_dataset', './test/data/tmp/dataset/h5/')
